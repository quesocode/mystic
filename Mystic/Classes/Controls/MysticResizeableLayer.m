...
//#define MYSTIC_UI_LAYER_BORDER_SIZE 10.0
...
@synthesize minimumWidth, minimumHeight, borderView;
...
-(void)resizeTranslate:(UIPanGestureRecognizer *)recognizer
{
    ...
    {
        if (self.bounds.size.width < minimumWidth || self.bounds.size.height < minimumHeight)
        {
...
- (void) setContentScale:(CGScale)contentScale;
{
    ...
    _globalInset = (_globalInset/_contentScale.x) * contentScale.x;
    ...
    contentView.frame = CGRectInset(self.bounds, _globalInset + MYSTIC_UI_LAYER_BORDER_SIZE/2, _globalInset + MYSTIC_UI_LAYER_BORDER_SIZE/2);
...
- (void)setupDefaultAttributes {
    ...
    resizingControl.frame = CGRectMake(self.frame.size.width-_controlSize.width,
                                       self.frame.size.height-_controlSize.height,
                                       _controlSize.width, _controlSize.height);
