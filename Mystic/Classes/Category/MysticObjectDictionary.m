...
@implementation MysticObjectDictionary
...
NSString *DescForObject2(NSObject *object, id locale, NSUInteger indent)
{
...
- (NSString *)descriptionWithLocale:(id)locale indent:(NSUInteger)level
{
	...
	for (NSObject *key in self)
	{
		[description appendFormat:@"%@    %@ = %@;\n",
         indentString,
         DescForObject2(key, locale, level),
         DescForObject2([self objectForKey:key], locale, level)];
	}
	[description appendFormat:@"%@}\n", indentString];
	return description;
}
