...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor color:MysticColorTypeWhite];
    ...
    // Attachments
    self.attachmentsView = [[UIView alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.textView.frame) + 40, CGRectGetWidth(self.view.frame) - 30, 22)];
...
//    MysticNavigationViewController *nav = [MysticNavigationViewController newNavigationWithController:viewController];
...
//    MBorder(self.textView, [UIColor blueColor], 1);
    // Move the seperator
