...
//    UINavigationController *nav = [MysticNavigationViewController newNavigationWithController:viewController];
...
- (void)setupUI
{
    ...
    self.tableView.backgroundColor = [UIColor color:MysticColorTypeWhite];
