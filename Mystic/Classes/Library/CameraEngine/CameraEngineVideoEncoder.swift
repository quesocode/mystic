...
public enum CameraEngineVideoEncoderEncoderSettings: String {
    ...
    fileprivate func avFoundationPresetString() -> String? {
        switch self {
...
class CameraEngineVideoEncoder {
    ...
    fileprivate var videoInputWriter: AVAssetWriterInput!
    fileprivate var audioInputWriter: AVAssetWriterInput!
    ...
    fileprivate func initVideoEncoder(_ url: URL) {
