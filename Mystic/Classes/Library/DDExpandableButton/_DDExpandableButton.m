...
- (CGRect)shrunkFrameRect
{
	...
	{
        if(labels && labels.count && labels.count < selectedItem)
        {
    ...
    return CGRectMake(self.frame.origin.x, self.frame.origin.y, 0 + cornerAdditionalPadding, maxHeight);
}
