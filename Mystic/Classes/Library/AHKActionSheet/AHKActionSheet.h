...
typedef NS_ENUM(NSInteger, MysticActionSheetStyle) {
    MysticActionSheetStyleDefault = 0,
    MysticActionSheetStyleDefaultNoBlur,
    MysticActionSheetStyleCancelArrow,
    MysticActionSheetStyleDefaultDark,
    MysticActionSheetStyleYesOrNo,
};
 ...
 */
@property (nonatomic, assign) MysticActionSheetStyle style;

@property (nonatomic) BOOL scrollEnabled;
@property (nonatomic) CGFloat blurRadius UI_APPEARANCE_SELECTOR;
@property (nonatomic) CGFloat titleHeight UI_APPEARANCE_SELECTOR;
...
@property (strong, nonatomic) UIImage *cancelButtonImage UI_APPEARANCE_SELECTOR;
@property (strong, nonatomic) UIImage *cancelButtonImageHighlighted UI_APPEARANCE_SELECTOR;
...
@property (strong, nonatomic) NSNumber *forceFitButtons UI_APPEARANCE_SELECTOR;
@property (strong, nonatomic) NSNumber *hideTopSeparator UI_APPEARANCE_SELECTOR;
@property (strong, nonatomic) NSNumber *hideBottomSeparator UI_APPEARANCE_SELECTOR;

@property (strong, nonatomic) NSNumber *disableBlur UI_APPEARANCE_SELECTOR;
...
@property (strong, nonatomic) NSNumber *hideLastSeparator UI_APPEARANCE_SELECTOR;
...
@property (nonatomic, weak) AHKActionSheet *sheet;
@property (nonatomic, assign) AHKActionSheetButtonType buttonType;
@end