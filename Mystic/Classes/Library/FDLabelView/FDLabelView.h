...
@property(nonatomic) BOOL debugShowFrameCenter;
...
@property(nonatomic) CGFloat debugFrameBorderWidth;
@property(nonatomic) CGFloat debugLineBreaksBorderWidth;
@property(nonatomic) CGFloat debugPaddingBorderWidth;

@property(nonatomic, retain) UIColor *debugFrameBorderColor;
@property(nonatomic, retain) UIColor *debugLineBreakBorderColor;
@property(nonatomic, retain) UIColor *debugPaddingBorderColor;
