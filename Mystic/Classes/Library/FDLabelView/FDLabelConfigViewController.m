...
-(void)updateCodes{
    ...
    [codes appendFormat:@"%@.numberOfLines = %ld;\n", labelView.outputName, (long)labelView.numberOfLines];
        ...
        case 1:{
            ...
            switch (indexPath.row) {
                ...
                case 2:{
                    ...
                    value.text = [NSString stringWithFormat:@"%ld", (long)labelView.numberOfLines];
...
- (void)tableView:(UITableView *)atableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        case 0: {
            UILabel* label = (UILabel*)[atableView cellForRowAtIndexPath:indexPath].accessoryView;
            switch (indexPath.row) {
                case 0:
