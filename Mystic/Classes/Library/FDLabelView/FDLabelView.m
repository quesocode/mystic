...
debugShowFrameCenter,
debugShowCoordinates,
debugShowPaddings,
debugSentences,
debugFrameBorderWidth,
debugLineBreaksBorderWidth,
debugPaddingBorderWidth,
debugPaddingBorderColor=_debugPaddingBorderColor,
debugLineBreakBorderColor=_debugLineBreakBorderColor,
debugFrameBorderColor=_debugFrameBorderColor;
...
- (id)init{
    ...
    if (self) {
        ...
        debugShowFrameCenter = NO;
        
        debugPaddingBorderWidth = 1;
        debugFrameBorderWidth = 1;
        debugLineBreaksBorderWidth = 2;
        
        _debugFrameBorderColor = [UIColor blueColor];
        _debugLineBreakBorderColor = [UIColor orangeColor];
        _debugPaddingBorderColor = [UIColor greenColor];
    }
    return self;
}
...
-(void)drawDebug:(NSArray*)linebreaks{
    ...
    if (debug) {
        ...
        if (debugShowLineBreaks) {
            CGContextSetLineWidth(ctx, self.debugLineBreaksBorderWidth);
//            CGContextSetRGBStrokeColor(ctx, 0.98f, 0.58f, 0.09f, 1);
            [self.debugLineBreakBorderColor setStroke];
        ...
        if (debugShowFrameBounds) {
            // frame
            CGContextSetLineWidth(ctx, self.debugFrameBorderWidth);
//            CGContextSetRGBStrokeColor(ctx, 0.28f, 0.54f, 1, 1);
            [self.debugFrameBorderColor setStroke];
            CGContextStrokeRect(ctx, CGRectInset(self.bounds, 0.5, 0.5));
            
            if(debugShowFrameCenter)
            {
        ...
        if (debugShowPaddings){
            ...
            CGContextSetLineWidth(ctx, self.debugPaddingBorderWidth);
//            CGContextSetRGBStrokeColor(ctx, 0.18f, 0.62f, 0.06f, 1);
            [self.debugPaddingBorderColor setStroke];
...
-(CGFloat)lineWidth:(NSString*)theText{
    CGFloat width = 0;
    width = [theText sizeWithFont:[self displayFont]].width;
    return width;
}
...
-(void)updateFrameIntegral:(CGRect)frame;
{
