...
@implementation ILGreenPickerView
...
-(void)drawRect:(CGRect)rect
{
    ...
    if(!self.color)
    {
        c1 = UIColor.greenColor;
        c2 = [[UIColor blackColor] colorWithMinBrightness:MYSTIC_UI_INPUT_MIN_BRIGHT];
    }
    else
    {
        v = self.rgb.green;
        ...
        rb.green = 0;
        c1 = [[UIColor colorWithRed:self.rgb.red green:1 blue:self.rgb.blue alpha:1] colorWithMinBrightness:MYSTIC_UI_INPUT_MIN_BRIGHT];
        c2 = [[UIColor colorWithRed:self.rgb.red green:MysticRGBisBlack(rb)?0.01:0 blue:self.rgb.blue alpha:1] colorWithMinBrightness:MYSTIC_UI_INPUT_MIN_BRIGHT];
