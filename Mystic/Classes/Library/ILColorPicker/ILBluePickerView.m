...
@implementation ILBluePickerView
...
-(void)drawRect:(CGRect)rect
{
    ...
    else
    {
        ...
        rb.blue = 0;
        c1 = [[UIColor colorWithRed:self.rgb.red green:self.rgb.green blue:1 alpha:1] colorWithMinBrightness:MYSTIC_UI_INPUT_MIN_BRIGHT];
        c2 = [[UIColor colorWithRed:self.rgb.red green:self.rgb.green blue:MysticRGBisBlack(rb)?0.01:0 alpha:1] colorWithMinBrightness:MYSTIC_UI_INPUT_MIN_BRIGHT];
    }
