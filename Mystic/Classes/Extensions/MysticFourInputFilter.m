...
NSString *const kMysticFourInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation MysticFourInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kMysticFourInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    fourFrameTime = kCMTimeInvalid;
    
    runSynchronouslyOnVideoProcessingQueue(^{
        [GPUImageContext useImageProcessingContext];
        filterFourTextureCoordinateAttribute = [filterProgram attributeIndex:@"inputTextureCoordinate4"];
        ...
        glEnableVertexAttribArray(filterFourTextureCoordinateAttribute);
    });
