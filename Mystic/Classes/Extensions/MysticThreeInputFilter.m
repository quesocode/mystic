...
NSString *const kMysticThreeInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation MysticThreeInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kMysticThreeInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
