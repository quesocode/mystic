...
NSString *const kMysticFiveInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation MysticFiveInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kMysticFiveInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    fiveFrameTime = kCMTimeInvalid;
    
    runSynchronouslyOnVideoProcessingQueue(^{
        [GPUImageContext useImageProcessingContext];
        filterFiveTextureCoordinateAttribute = [filterProgram attributeIndex:@"inputTextureCoordinate5"];
        
        filterInputTextureUniform5 = [filterProgram uniformIndex:@"inputImageTexture5"];        glEnableVertexAttribArray(filterFiveTextureCoordinateAttribute);
    });
